{if !$user->_logged_in}
    <body {if $smarty.get.e!='' }
	     onload="alogin('{$smarty.get.e}')"
	     
	 {/if} data-hash-tok="{$session_hash['token']}" data-hash-pos="{$session_hash['position']}" class="{if $system['theme_mode_night']}night-mode{/if} visitor n_chat {if ($page == 'index' && !$system['newsfeed_public']) || $page == 'sign'}index-body{/if}" {if ($page == 'index' || $page == 'sign') && !$system['system_wallpaper_default'] && $system['system_wallpaper']} style="background-image: url('{$system['system_uploads']}/{$system['system_wallpaper']}'); background-size: cover;" {/if} {if $page == 'profile' && $system['system_profile_background_enabled'] && $profile['user_profile_background']}style="background: url({$profile['user_profile_background']}) fixed !important; background-size: 100% auto;"{/if}>
{else}
                ...
                <div class="row">
                    ...
                    <div class="{if !$user->_logged_in}col-6{/if} col-md-4 col-lg-3 {if $user->_logged_in}d-none d-md-block{/if}">
                        ...
                        <div class="logo-wrapper">
                            ...
                            <!-- logo -->
                            <a title=" Network Home" href="{$system['system_url']}" class="logo {if !$user->_logged_in && $system['newsfeed_public']}with-menu-icon{/if}">
                                {if $system['system_logo']}
                                    <img class="img-fluid" src="{$system['system_uploads']}/{$system['system_logo']}" alt=" Network Home" title=" Network Home">
                                {else}
                                    {$system['system_title']}
                                {/if}
                            </a>
                                        ...
                                        {if $user->_logged_in}
                                            ...
                                            <li class="dropdown">
                                                ...
                                                <div class="dropdown-menu dropdown-menu-right">
                                                    ...
                                                    <a class="dropdown-item" href="https://anywhereanycity.com/home/user-logout">{__("Log Out")}</a>
                                                    <div class="dropdown-divider"></div>
