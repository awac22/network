					...
					<ul class="side-nav">
						{if $view != "category"}
							<li class="active">
								...
								<a href="{$system['system_url']}/fleamarket">
	                                {__("All")}
	                            </a>
							</li>
						{else}
							<li>
								{if $current_category['parent']}
									...
									<a href="{$system['system_url']}/fleamarket/category/{$current_category['parent']['category_id']}/{$current_category['parent']['category_url']}">
						...
						{foreach $categories as $category}
							<li {if $view == "category" && $current_category['category_id'] == $category['category_id']}class="active"{/if}>
								...
								<a href="{$system['system_url']}/fleamarket/category/{$category['category_id']}/{$category['category_url']}">
