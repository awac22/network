...
try {
	...
	if(strpos($event['event_cover'],"events.anywhereanycity.com") !=false){
		
	  $event['event_cover'] =str_replace('https://anywhereanycity.com/network/content/uploads/','',$event['event_cover']);	
	  $event['event_cover_full'] = $event['event_cover'];
	} 
